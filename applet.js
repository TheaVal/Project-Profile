const studentName = "ALTHEA VALERIE G. ALGUZAR";

const schools = [
  {
    name: "Dalirig Elementary School",
    info: "Dalirig Elementary School is where I started my primary education, building the foundation for my learning journey.",
